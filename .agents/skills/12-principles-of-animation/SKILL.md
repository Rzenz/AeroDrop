...
description: Audit animation code against Disney's 12 principles adapted for web and mobile. Use when reviewing motion, implementing animations, or checking animation quality. Outputs file:line findings.
license: MIT
metadata:
...
Review animation code for compliance with Disney's 12 principles adapted for web and mobile interfaces.
